...
public class Manager : MonoBehaviour { // used to manage all inventories and prefabs required for each 
    ...
    public GameObject mana, health, power, iceSpell, fireSpell, pushSpell, strength, swift,armor,sword,boots; // types of itemPrefabs available // add sjop_mana item to test shop function
